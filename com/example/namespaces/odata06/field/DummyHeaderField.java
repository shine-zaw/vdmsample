...
package com.example.namespaces.odata06.field;
...
/**
 * Template class to represent entity fields of the Entity {@link com.example.namespaces.odata06.DummyHeader DummyHeader}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class DummyHeaderField<FieldT >
    extends EntityField<DummyHeader, FieldT>
    implements DummyHeaderSelectable
{
     ...
     */
    public DummyHeaderField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public DummyHeaderField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
