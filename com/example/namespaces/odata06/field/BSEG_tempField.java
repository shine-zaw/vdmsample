...
/**
 * Template class to represent entity fields of the Entity {@link com.example.namespaces.odata06.BSEG_temp BSEG_temp}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BSEG_tempField<FieldT >
    extends EntityField<BSEG_temp, FieldT>
    implements BSEG_tempSelectable
{
     ...
     */
    public BSEG_tempField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BSEG_tempField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
