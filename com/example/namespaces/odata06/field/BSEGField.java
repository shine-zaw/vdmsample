...
/**
 * Template class to represent entity fields of the Entity {@link com.example.namespaces.odata06.BSEG BSEG}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BSEGField<FieldT >
    extends EntityField<BSEG, FieldT>
    implements BSEGSelectable
{
     ...
     */
    public BSEGField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public BSEGField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
