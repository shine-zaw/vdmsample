...
/**
 * Template class to represent entity navigation links of {@link com.example.namespaces.odata06.BSEG_temp BSEG_temp} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.example.namespaces.odata06.link.BSEG_tempLink BSEG_tempLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BSEG_tempOneToOneLink<ObjectT extends VdmObject<?> >
    extends BSEG_tempLink<ObjectT>
    implements OneToOneLink<BSEG_temp, ObjectT>
{
     ...
     */
    public BSEG_tempOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BSEG_temp> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<BSEG_temp>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
