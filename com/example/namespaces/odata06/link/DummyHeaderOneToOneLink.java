...
/**
 * Template class to represent entity navigation links of {@link com.example.namespaces.odata06.DummyHeader DummyHeader} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.example.namespaces.odata06.link.DummyHeaderLink DummyHeaderLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class DummyHeaderOneToOneLink<ObjectT extends VdmObject<?> >
    extends DummyHeaderLink<ObjectT>
    implements OneToOneLink<DummyHeader, ObjectT>
{
     ...
     */
    public DummyHeaderOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<DummyHeader> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<DummyHeader>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
